...
class MonitoringController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('monitoring.index', compact('alokasis', 'periodes', 'bidangs', 'tahunList', 'sbmlWarnings', 'kegiatans', 'volumeList', 'sbmlTahun', 'sbmlPencacahan', 'sbmlPengolahan'));
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'nomor_spk' => 'nullable|string|max:150',
            'nomor_bast' => 'nullable|string|max:150',
