        ...
        <div class="row g-3 mb-4">
                ...
                <div class="card metric-card metric-card-primary shadow-sm h-100">
                    <div class="card-body d-flex align-items-center justify-content-between p-3.5">
                        <div>
                            ...
                            <h3 class="fw-extrabold text-white mt-1 mb-0 text-nowrap" style="font-size: 1.6rem;" data-counter-value="{{ $paguMataAnggaran }}" data-counter-prefix="Rp ">Rp {{ number_format($paguMataAnggaran, 0, ',', '.') }}</h3>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card metric-card metric-card-success shadow-sm h-100">
                    <div class="card-body d-flex align-items-center justify-content-between p-3.5">
                        <div>
                            <span class="text-white-50 small fw-bold text-uppercase" style="font-size: 0.9rem;">Realisasi Pengeluaran</span>
                            <h3 class="fw-extrabold text-white mt-1 mb-0 text-nowrap" style="font-size: 1.6rem;" data-counter-value="{{ $realisasiHonor }}" data-counter-prefix="Rp ">Rp {{ number_format($realisasiHonor, 0, ',', '.') }}</h3>
                            <span class="text-white-50" style="font-size: 0.85rem;">{{ count($bulanPencairan) }} Bulan Terpilih ({{ $tahun }})</span>
                        </div>
                ...
                <div class="card metric-card {{ $sisaAnggaran < 0 ? 'metric-card-danger' : 'metric-card-warning' }} shadow-sm h-100">
                    <div class="card-body d-flex align-items-center justify-content-between p-3.5">
                        <div>
                            ...
                            <h3 class="fw-extrabold text-white mt-1 mb-0 text-nowrap" style="font-size: 1.6rem;" data-counter-value="{{ $sisaAnggaran }}" data-counter-prefix="Rp ">Rp {{ number_format($sisaAnggaran, 0, ',', '.') }}</h3>
                            <span class="text-white-50" style="font-size: 0.85rem;">Pagu − Realisasi ({{ $paguMataAnggaran > 0 ? round(($realisasiHonor / $paguMataAnggaran) * 100) : 0 }}% terpakai)</span>
                        </div>
