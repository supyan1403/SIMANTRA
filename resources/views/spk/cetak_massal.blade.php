...
<div class="page">
    ...
    <table class="ms-2 mb-3" style="width: 100%;">
        ...
        <tr valign="top">
            ...
            <td>: {{ $b->mitra->pekerjaan ?? 'Lainnya / Belum Bekerja' }}, berkedudukan di {{ $b->mitra->alamat ?? 'Kabupaten Tasikmalaya' }}, bertindak untuk dan atas nama diri sendiri, selanjutnya disebut sebagai <strong>PIHAK KEDUA</strong>.</td>
        </tr>
    </table>
    ...
    <ol class="ps-3 mb-0">
        <li>PIHAK KEDUA berhak untuk mendapatkan honorarium petugas dari PIHAK PERTAMA sebesar <strong>Rp {{ number_format($b->total_honor, 0, ',', '.') }}</strong> untuk pekerjaan sebagaimana dimaksud dalam Pasal 2, termasuk biaya pajak, bea materai, pulsa dan kuota internet untuk komunikasi, dan jasa pelayanan keuangan.</li>
    ...
    <ol class="ps-3 mb-0">
        <li>Apabila PIHAK KEDUA mengundurkan diri pada saat/setelah pelaksanaan pekerjaan lapangan dengan tidak menyelesaikan pekerjaan yang menjadi tanggung jawabnya, maka wajib membayar ganti rugi kepada PIHAK PERTAMA sebesar <strong>Rp {{ number_format($b->total_honor, 0, ',', '.') }}</strong>.</li>
...
<!-- HALAMAN LAMPIRAN SPK -->
<div class="page">
    <div class="text-end extra-small text-muted mb-2">Lampiran SPK: {{ strtoupper($b->mitra->nama) }}</div>
