...
<div class="no-print text-center py-3 bg-dark text-white sticky-top d-flex align-items-center justify-content-center gap-2">
    <button onclick="window.print()" class="btn btn-danger fw-bold px-4 shadow-sm">
        <i class="bi bi-printer-fill me-1.5"></i> CETAK DOKUMEN (PRINTER)
    </button>
...
<div class="page-portrait">
    ...
    <table class="mb-3" style="width: 100%; font-size: 11pt; border-collapse: collapse;">
        ...
        <tr valign="top">
            <td style="padding-bottom: 0;">2. {{ strtoupper($mitra->nama) }}</td>
            <td style="text-align: center; padding-bottom: 0;">:</td>
            <td style="text-align: justify; padding-bottom: 0;">{{ $mitra->pekerjaan_clean }}, berkedudukan di {{ $mitra->alamat_clean }}, bertindak untuk dan atas nama diri sendiri, selanjutnya disebut <strong>PIHAK KEDUA</strong>.</td>
        </tr>
    </table>
...
<div class="page-portrait">
    ...
    <ol class="ps-3 mb-2">
        <li class="mb-2"><strong>PIHAK KEDUA</strong> berhak untuk mendapatkan honorarium petugas dari <strong>PIHAK PERTAMA</strong> sebesar <strong>Rp {{ number_format($totalHonor, 0, ',', '.') }} ({{ $terbilangHonor }})</strong> untuk pekerjaan sebagaimana dimaksud dalam Pasal 2, termasuk biaya pajak, bea materai, pulsa dan kuota internet untuk komunikasi, dan jasa pelayanan keuangan.</li>
...
<div class="page-landscape">
    <div class="d-flex justify-content-end mb-2" style="font-size: 9.5pt; color: #7f7f7f;">
        <div class="text-start" style="width: 250px;">
            <div>Lampiran {{ strtoupper($mitra->nama) }}</div>
        </div>
    </div>
        ...
        <tfoot>
            <tr class="fw-bold" style="background: #f8fafc;">
                <td colspan="6" class="text-start ps-3" style="font-style: italic; font-weight: normal;">
                    <em>Terbilang: {{ $terbilangHonor }}</em>
                </td>
